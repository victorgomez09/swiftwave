...
<template>
  ...
  <div class="label">
    <span class="label-text !font-semibold">Persistent Volume</span>
  </div>
            <input
              id="name"
  ...
  <div class="label">
    <span class="label-text !font-semibold">Type</span>
        ...
        <div v-if="newPersistentVolumeDetails.type === 'nfs'" class="mt-2">
          <label class="form-control w-full">
            <div class="label">
              <span class="label-text !font-semibold">NFS Server Host</span>
            </div>
            <input
        ...
        <div v-if="newPersistentVolumeDetails.type === 'nfs'" class="mt-2">
          <label class="form-control w-full">
            <div class="label">
              <span class="label-text !font-semibold">NFS Share Path</span>
            </div>
            <input
        ...
        <div v-if="newPersistentVolumeDetails.type === 'nfs'" class="mt-2">
          <label class="form-control w-full">
            <div class="label">
              <span class="label-text !font-semibold">NFS Version</span>
            </div>
            <select
        ...
        <div v-if="newPersistentVolumeDetails.type === 'cifs'" class="mt-2">
          <label class="form-control w-full">
            <div class="label">
              <span class="label-text !font-semibold">CIFS Host</span>
            </div>
            <input
        ...
        <div v-if="newPersistentVolumeDetails.type === 'cifs'" class="mt-2">
          <label class="form-control w-full">
            <div class="label">
              <span class="label-text !font-semibold">CIFS Share</span>
            </div>
            <input
