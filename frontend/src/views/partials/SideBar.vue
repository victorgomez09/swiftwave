    ...
    <div class="px-3">
      <RouterLink to="/">
        ...
        <div class="flex flex-col">
          <h4 class="w-full max-w-40 font-semibold">Vira Deploy</h4>
          <p class="m-0 p-0 text-sm font-thin">Lightweight pass</p>
        </div>
      </RouterLink>
    </div>
      ...
      <nav>
        <SideBarOption :active-urls="['Deploy Application', 'Deploy Stack', 'App Store', 'Install from App Store']">
          ...
          <template #content>
            <div class="space-y-2">
              <RouterLink
                class="flex transform items-center rounded-lg px-3 py-2  transition-colors duration-300 hover:bg-gray-50 hover:text-gray-700"
                to="/deploy/app-store">
        ...
        <SideBarOption :active-urls="['Applications', 'Persistent Volumes']">
          ...
          <template #content>
            <div class="space-y-2">
              <RouterLink
                class="flex transform items-center rounded-lg px-3 py-2  transition-colors duration-300 hover:bg-gray-100 hover:text-gray-700"
                to="/applications">
                <font-awesome-icon icon="fa-solid fa-box" />
...
.router-link-exact-active {
  @apply bg-base-100 text-accent-content;
}
