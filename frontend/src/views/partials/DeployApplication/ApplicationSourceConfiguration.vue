  ...
  <div :key="2" class="mt-5 flex h-full w-full flex-row justify-evenly p-6">
    <div class="w-1/2 max-w-md">
      ...
      <div v-if="applicationSourceType === 'git'" class="w-full">
        ...
        <div class="mt-4">
          <label class="form-control w-full">
            <div class="label">
              <span class="label-text">Git Repository URL<span class="text-red-600"> *</span></span>
            </div>
            <input id="git_repo_url" v-model="stateRef.gitRepoUrl" autocomplete="off"
              class="input input-bordered w-full" name="name" placeholder="Enter Git Repository URL" type="text"
        ...
        <div class="mt-4">
          <label class="form-control w-full">
            <div class="label">
              <span class="label-text">Git Branch<span class="text-red-600">
                  *</span>
                <span class="ml-2 italic" v-if="fetchingGitBranches"><font-awesome-icon icon="fa-solid fa-spinner"
                    class="animate-spin" />&nbsp;&nbsp;Fetching...</span></span>
            </div>
            <select id="git_credential" v-model="stateRef.gitBranch" class="select select-bordered w-full">
      ...
      <div v-else-if="applicationSourceType === 'image'" class="w-full">
        ...
        <div class="mt-6">
          <label class="form-control w-full">
            <div class="label">
              <span class="label-text">Docker Image <span class="text-red-600"> *</span></span>
            </div>
            <input id="docker_image" v-model="stateRef.dockerImage" autocomplete="off"
              class="input input-bordered w-full" name="name" placeholder="Enter Docker Image URL" type="text" />
          </label>
        </div>
        ...
        <div class="mt-4">
          <label class="form-control w-full">
            <div class="label">
              <span class="label-text">Pick Image Registry
                Credential (Optional)</span>
            </div>
      ...
      <FilledButton :disabled="!enableGenerateConfigurationButton" :loading="dockerConfigGeneratorGenerating"
        class="mt-6 w-full" type="primary" @click="generateConfiguration">Generate Configuration
      </FilledButton>
    </div>
    ...
    <div v-if="stateRef.isDockerConfigurationGenerated" class="w-1/2 max-w-md">
      ...
      <div class="mt-4">
        ...
        <div class="mt-1">
          <input id="docker_command" v-model="stateRef.command" autocomplete="off" class="input input-bordered w-full"
