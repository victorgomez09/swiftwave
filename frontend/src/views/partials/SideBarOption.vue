...
<template>
  <Disclosure v-slot="{ open }">
    <div
      ...
      <DisclosureButton
        as="button"
        class="flex w-full items-center justify-between rounded-lg bg-opacity-20 bg-clip-padding px-3 py-1.5 text-base-content backdrop-blur-sm backdrop-filter">
        <div>
          <slot name="icon"></slot>
